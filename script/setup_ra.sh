...
scp -r root@192.168.85.203:/TestFolder/sources/to_send ./to_receive
...
python3 ./script/ra_db.py $sha256 ../../Agents/Remote_Attestor/AKs/ak.pub.imx.pem ../certs/server.imx.crt file:../../Protocols/Explicit/goldenvalues.imx.db